  ...
  return (
    ...
    <section className="grid w-full gap-8 home-section">
      ...
      <div className="md-col-span xl:col-span-2">
         <TradingViewWidget
        title="Stock Heatmap"
        scriptUrl={`${scriptUrl}stock-heatmap.js`} config={HEATMAP_WIDGET_CONFIG}  height={600}/>
      </div>

    </section>

    <section className="h-full md:col-span-1 xl:col-span-1">
      <div className="md:col-span-1 xl:col-span-1 ">
        <TradingViewWidget
      ...
      <div className="h-full md:col-span-1 xl:col-span-2">
        ...
        scriptUrl={`${scriptUrl}market-quotes.js`} config={MARKET_DATA_WIDGET_CONFIG}  height={600}/>
      </div>
